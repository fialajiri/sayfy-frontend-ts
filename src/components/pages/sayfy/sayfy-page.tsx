      ...
      <section className="sayfy-intro">       
        ...
        <div className="sayfy-intro__text-container">
          <h1 className="heading-primary sayfy-intro__heading">
            David <span className="sayfy-intro__heading-nick">„Sayfy“</span> Seifrt
          </h1>
      ...
      <section className="sayfy-main">
        <div className="sayfy-main__blok-container">
          <p className="sayfy-main-text">
            David Seifrt, přezdívaný Sayfy, se narodil 8. 2. 1991 v Teplicích. Již od nejútlejšího
            dětství bylo jasné, že z něj roste sportovec. Nejdříve trávil všechen mimoškolní (někdy
            i školní) čas na ledě v dresech HC Stadion Teplice, později HC Draci Bílina. Ovšem po
            čase hokej nahradila cyklistika, do které se Sayfy opravdu zamiloval.
          </p>
        ...
        <div className="sayfy-main__blok-container sayfy-main__blok-container-odd">
          <p className="sayfy-main-text">
            První úspěchy sklízel v týmu Top Ten Teplice, později přejmenovaný na Factor team. Po
            dvou letech vystoupil o stupínek výše do týmu TJ Stadion Louny – Zannela, kde se věnoval
            především silniční cyklistice a cyklocrossu. Svoji snahu dovršil tím, že byl přijat do
        ...
        <div className="sayfy-main__blok-container">
          <p className="sayfy-main-text">
            Snažil se vyhrávat a když to někdy nevyšlo, prohlásil své nejoblíbenější heslo: „ASPOŇ
            JSEM TO ZKUSIL“. Byl závodníkem, který i přes utržené šrámy neměl strach a na svého
            „šemíka“ nedal dopustit.
          </p>
        ...
        <div className="sayfy-main__blok-container sayfy-main__blok-container-odd">
          <p className="sayfy-main-text">
            David zemřel při tragické nehodě v neděli 28.9. 2008 v Krupce u Teplic. Pro uctění jeho
            památky každý rok pořádáme cyklistický závod SAYFYHO Memorial. Jak jinak by všichni měli
            strávit tento den než na kolech…
          </p>
